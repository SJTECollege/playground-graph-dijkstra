...
def test_set_current_node():
    try:
        ...
        assert count == "F", '''Running set_current_node({"A"}, {"A":0, "B":5, "C":inf, "D":inf, "E":4, "F":3, "G":5}), expected "F", got "{}".'''.format(count)
        count = set_current_node({"A","F"}, {"A":0, "B":5, "C":inf, "D":inf, "E":4, "F":3, "G":5})
        assert count == "E", '''Running set_current_node({"A","F"}, {"A":0, "B":5, "C":inf, "D":inf, "E":4, "F":3, "G":5}), expected "E", got "{}".'''.format(count)
        success()
